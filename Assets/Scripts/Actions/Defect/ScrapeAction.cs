...
public class ScrapeAction : AbstractGameAction
{
    private bool isShuffleCheck;
    private List<AbstractCard> scrapedCards = new List<AbstractCard>();

    public ScrapeAction(AbstractCreature _source, int _amount, bool _isEndTurnDraw)
    {
    ...
    public ScrapeAction(AbstractCreature _source, int _amount) : this(_source, _amount, false)
    {
